---
title: "ankhang"
description: "A command line for ankhang."
heroTitle: "ankhang, from the command line"
heroLead: "A command line for ankhang. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
ankhang links <path>           # the pages it links to, each addressable
ankhang serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading ankhang by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address ankhang as
  `ankhang://` URIs and follow links across sites. See
